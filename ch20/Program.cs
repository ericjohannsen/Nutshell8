...
{
    // Requires:
    // dotnet add package DynamicLanguageRuntime
    ...
    class Program
    {
        ...
        {
            {"--pycalc", new CmdInfo() { Command = (o) => { ScriptingDemo.RunCalc(); }}},
            {"--pystate", new CmdInfo() { Command = (o) => { ScriptingDemo.RunPassingState(); }}},
            {"--pyret", new CmdInfo() { Command = (o) => { ScriptingDemo.RunReturn(); }}},
            {"--pymarshal", new CmdInfo() { Command = (o) => { ScriptingDemo.RunMarshal(); }}},
